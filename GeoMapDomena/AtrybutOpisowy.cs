...
namespace GeoMapDomena
{
    ...
    public class AtrybutOpisowy : IEnumerable<string>
    {
        ...
        public string Wartość
        {
            get
            {
                if (_wartości.Count > 1) throw new InvalidOperationException("Atrybut zawiera listę wartości");
        ...
        public bool JestListą { get { return _wartości.Count > 0; } }
